  ...
  Widget build(BuildContext context) {
    ...
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: themeProvider.backgroundColor,
          title: Text("Settings", style: TextStyles.title(context: context, color: themeProvider.accentColor)),
          centerTitle: false,
        ...
        body: ListView(
          ...
          children: [
            ...
            ListTile(
              ...
              onTap: (){
                Navigator.of(context).pushNamed(NotesAndRemindersRoute().route);
              },
            ),
            Divider(),
            ListTile(
            ...
            ListTile(
              ...
              title: Text("Change distance filter", style: TextStyles.body(context: context, color: themeProvider.textColor)),
              trailing: Icon(Icons.arrow_forward_ios_rounded, color: themeProvider.hintColor, size: 16),
              dense: true,
              visualDensity: VisualDensity.compact,
              onTap: () {
                showModalBottomSheet(context: context, builder: (context) => DistanceFilter());
              },
            ),
            Divider(),
            ListTile(
